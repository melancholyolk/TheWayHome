...
{
	static HashSet<Type> scriptableObjectTypes = Enumerable.ToHashSet(AssemblyUtilities.GetTypes(AssemblyTypeFlags.CustomTypes)
		.Where(t =>
			t.IsClass &&
			typeof(ScriptableObject).IsAssignableFrom(t) &&
			!typeof(EditorWindow).IsAssignableFrom(t) &&
			!typeof(Editor).IsAssignableFrom(t)
			&& t.Namespace != null && t.Namespace.StartsWith("ACT")
		));
